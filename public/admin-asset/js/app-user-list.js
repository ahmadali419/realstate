...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ajax: {
          url: '/admin/users/listing', // API endpoint URL
          dataSrc: 'data', // The property in the response containing the data
      },
      columns: [
          { data: 'username' }, // Map the 'username' property from the API response to this column
          { data: 'role' }, // Map the 'role' property from the API response to this column
          { data: 'mobile' } // Map the 'phone' property from the API response to this column
      ],
      columnDefs: [
        {
          // For Responsive
