...
@section('content')
  ...
  <div class="card">
    <div class="card-header border-bottom">
      <h5 class="card-title mb-3">Sliders List</h5>
      ...
      <div class="row">
        ...
        <div class="dt-buttons btn-group flex-wrap" style="float: right"><button class="btn btn-secondary add-new btn-primary mx-3" tabindex="0" aria-controls="DataTables_Table_0" type="button"
          ...
          data-bs-target="#addNewCCModal"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add New Slider</span></span></button> </div>
        </div>
      </div>
    </div>
        ...
        <tbody>
          @foreach ($sliders as $category)
            <tr>
              ...
              <td><img src="{{ asset('admin-asset/images/slider_images/' . $category->image) }}" width="50" height="50" alt=""></td>
              <td>
      ...
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body">
          ...
          <div class="text-center mb-4">
            <h3 class="mb-2">Add New Slider</h3>
          </div>
...
Dropzone.options.myDropzone = {
  ...
  $(document).on('click', '.edit-record', function() {
    ...
    var url = "{{ route('slider.sliderEdit', ['id' => ':id']) }}";
