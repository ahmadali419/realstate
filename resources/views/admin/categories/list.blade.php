    ...
    <div class="card-header border-bottom">
      ...
      <div class="row">
        ...
        <div class="dt-buttons btn-group flex-wrap" style="float: right"><button class="btn btn-secondary add-new btn-primary mx-3" tabindex="0" aria-controls="DataTables_Table_0" type="button"
          ...
          data-bs-target="#addNewCCModal"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add New Category</span></span></button> </div>
        </div>
      </div>
    </div>
        ...
        <tbody>
          @foreach ($categories as $category)
            <tr>
              ...
              <td><img src="{{ asset('admin-asset/images/category_images/' . $category->image) }}" width="50" height="50" alt=""></td>
              <td>
...
Dropzone.options.myDropzone = {
  ...
  $(document).on('click', '.edit-record', function() {
    ...
    var url = "{{ route('category.categoryEdit', ['id' => ':id']) }}";
