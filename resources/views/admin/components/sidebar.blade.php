<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" >
  <div class="app-brand demo" style="margin-top:10px;margin-bottom:10px">
...
@if(auth()->check() && auth()->user()->role_id === 1)
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ route('role.roleList') }}" class="menu-link">
            <div data-i18n="List">List</div>
          </a>
        </li>
      </ul>
    ...
    @endif
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">Catalog & Properties</span>
    </li>
  @if(auth()->check() && auth()->user()->role_id === 1)
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ route('category.categoryList') }}" class="menu-link">
            <div data-i18n="List">list</div>
          </a>
        </li>
      </ul>
  ...
  @endif
  @if((auth()->check() && auth()->user()->role->name === 'Admin') || auth()->user()->role->name === 'Agent')
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ route('feature.featureList') }}" class="menu-link">
            <div data-i18n="list">list</div>
          </a>
        </li>
      </ul>
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ route('property.propertyList') }}" class="menu-link">
            <div data-i18n="list">list</div>
          </a>
        </li>
      </ul>
  ...
  @if(auth()->check() && auth()->user()->role_id === 1)
    ...
    <li class="menu-item">
      <a href="{{ route('service.serviceList') }}" class="menu-link">
    ...
    <li class="menu-item">
      <a href="{{ route('testimonial.testimonialList') }}" class="menu-link">
        <i class="menu-icon tf-icons ti ti-components"></i>
        <div data-i18n="Testimonials">Testimonials</div>
      </a>
    </li>
    <li class="menu-item">
      <a href="{{ route('content.contentList') }}" class="menu-link">
        <i class="menu-icon tf-icons ti ti-square"></i>
        <div data-i18n="Who we are?">Who we are?</div>
      </a>
    </li>
    <li class="menu-item">
      <a href="{{ route('slider.sliderList') }}" class="menu-link">
    ...
    <li class="menu-item">
      <a href="{{ route('setting.setting') }}" class="menu-link">
        <i class="menu-icon tf-icons ti ti-settings"></i>
        <div data-i18n="Home Page Setting">Home Page Setting</div>
      </a>
    </li>
    @endif
