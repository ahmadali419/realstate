...
class ContentController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin.contents.list',get_defined_vars());
      }
      ...
      public function store(Request $request)
      {
          ...
          if ($request->id) {
              unset($rules['image']);
              $feature = Content::find($request->id);
          } else {
          ...
          if ($request->hasFile('image')) {
              ...
              $imagePath = public_path('admin-asset/images/content_images');
          ...
          return response()->json(['status' => true, 'message' => 'Content Created successfully!']);
      }
      
    
      public function delete(Request $request)
      {
          $service = Content::find($request->id);
          if (!$service) {
          ...
          if ($service->image) {
              $imagePath = public_path('admin-asset/images/content_images/' . $service->image);
              if (file_exists($imagePath)) {
      ...
      public function edit(Request $request){
         $services = Content::find($request->id);
         return $services;
      }
}