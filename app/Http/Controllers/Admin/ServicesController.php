...
class ServicesController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin.services.list',get_defined_vars());
      }
      ...
      public function store(Request $request)
      {
          ...
          if ($request->id) {
              unset($rules['image']);
              $feature = Service::find($request->id);
          } else {
          ...
          if ($request->hasFile('image')) {
              ...
              $imagePath = public_path('admin-asset/images/service_images');
      ...
      public function delete(Request $request)
      {
          ...
          if ($service->image) {
              $imagePath = public_path('admin-asset/images/service_images/' . $service->image);
              if (file_exists($imagePath)) {
